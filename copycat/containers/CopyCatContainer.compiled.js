(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    */
      ...
      _createClass(CopyCat, [{
        ...
        value: function render() {
          ...
          return _react3.default.createElement(
            ...
            _react3.default.createElement('input', { type: 'text', onChange: handleChange, value: input }),
    ...
    CopyCat.propTypes = {
      copying: _propTypes2.default.string.isRequired,
    ...
    var CopyCatContainer = _wrapComponent('CopyCatContainer')(function (_React$Component) {
      ...
      _createClass(CopyCatContainer, [{
        ...
        key: 'render',
        value: function render() {
          return _react3.default.createElement(_CopyCat.CopyCat, { copying: this.state.copying, toggleTape: this.toggleTape, input: this.state.input, handleChange: this.handleChange, name: this.state.name });
        }
      }]);
